...
namespace ODGJ.Lobby
{
    ...
    public class PadepokanManager : MonoBehaviour
    {
        ...
        [SerializeField] private TextMeshProUGUI cueTMP;
        ...
        private void Start()
        {
            ...
            {
                Debug.LogWarning("[PadepokanManager] AudioManager NOT FOUND!");
            }
        ...
        private void UnlockCurrentGhost()
        {
            ...
            if (PlayerWallet.Instance.Money < _currentSelected.unlockPrice)
            {
                ...
                if (_cueBlinkCoroutine == null)
                {
                    ...
                    _cueBlinkCoroutine = StartCoroutine(CueBlinkRoutine("Duit lu kurang bos!"));
                }
                return;
            }
        ...
        private void UpgradeGhost()
        {
            ...
            {
                cueText.SetActive(true);
                _cueBlinkCoroutine = StartCoroutine(CueBlinkRoutine("Fitur Upgrade segera hadir!"));
            }
            Debug.Log($"Mencoba Upgrade hantu {_currentSelected.ghostData.ghostName}...");
            // TODO: Logic nambahin stat SO hantu ditaruh di sini
        }

        private System.Collections.IEnumerator CueBlinkRoutine(String text)
        {
            cueTMP.text = text;
            float elapsed = 0f;
